	...
	function(exports) {
		...
		$("body").on("click", ".setting", function() {
			...
			html += '<div class="more-menu-list">' +
				...
				'<i class="layui-icon layui-icon-read" style="font-size: 19px;"></i> 功能开发中' +
				'</a>' +
				'<a class="more-menu-item" href="#" target="_blank">' +
				'<i class="layui-icon layui-icon-tabs" style="font-size: 16px;"></i> 功能开发中' +
				'</a>' +
				'<a class="more-menu-item" href="#" target="_blank">' +
				'<i class="layui-icon layui-icon-theme"></i> 功能开发中' +
				'</a>' +
				'<a class="more-menu-item" href="#" target="_blank">' +
				'<i class="layui-icon layui-icon-survey"></i> 功能开发中' +
				'</a>' +
				'</div>';
